...
Write-Host "`n最近输出文件:"
Get-ChildItem 'F:\ComfyUI-aki-v3.2\ComfyUI\output\*.png' -ErrorAction SilentlyContinue |
...
Get-ChildItem 'F:\ComfyUI-aki-v3.2\ComfyUI\models\checkpoints\*.safetensors' -ErrorAction SilentlyContinue |
